...
export function profileForSymbol(symbol) {
  ...
  const profiles = {
    ...
    'BTC-USD': {
      company: 'Bitcoin / BTC', score: 72, riskLevel: 'กลาง-สูง',
      thesis: 'สินทรัพย์หลักของตลาดคริปโต ต้องดู ETF flow, macro liquidity, funding/open interest, whale movement, exchange flow และ social hype',
      support: null, resistance: null, stopLoss: null
    },
    'ETH-USD': {
      company: 'Ethereum / ETH', score: 66, riskLevel: 'กลาง-สูง',
      thesis: 'คริปโตแกน ecosystem และ staking ต้องดู BTC trend, ETF narrative, on-chain activity และ funding',
      support: null, resistance: null, stopLoss: null
    },
    'SOL-USD': {
      company: 'Solana / SOL', score: 62, riskLevel: 'สูง',
      thesis: 'คริปโต momentum สูง ต้องคุมความเสี่ยงจาก social hype, liquidity และ BTC dominance',
      support: null, resistance: null, stopLoss: null
    },
    'DOGE-USD': {
      company: 'Dogecoin / DOGE', score: 52, riskLevel: 'สูงมาก',
      thesis: 'เหรียญ social-driven ผันผวนสูง ต้องดู hype, volume, liquidity และจุดตัดขาดทุนอย่างเข้มงวด',
      support: null, resistance: null, stopLoss: null
    }
  };
