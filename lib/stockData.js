...
function sampleProfileForTicker(ticker) {
  ...
  const known = {
    ...
    'BTC-USD': { last: 104000, volatility: 0.036, drift: 0.0008, baseVolume: 42000000000 },
    'ETH-USD': { last: 3600, volatility: 0.045, drift: 0.0006, baseVolume: 21000000000 },
    'SOL-USD': { last: 165, volatility: 0.065, drift: 0.0004, baseVolume: 5200000000 },
    'DOGE-USD': { last: 0.18, volatility: 0.078, drift: 0.0001, baseVolume: 1800000000 }
  };
