...
## อัปเดต v2.2.8: เรียงข่าวตามวันที่

เวอร์ชันนี้ปรับเมนู **สรุปข่าวสำคัญ (แปลไทย)** ให้เรียงข่าวตามวันที่:

- เรียงจากข่าวล่าสุด → ข่าวเก่าสุด
- ปรับทั้งการ์ดด้านล่าง
- ปรับทั้งหน้า Modal รายละเอียดข่าวทั้งหมด
- แสดงวันที่ให้อ่านชัดขึ้นในรูปแบบวันที่ไทย
- ยังใช้สีเดิมตามความหมายของข่าว:
  - ข่าวดี = สีเขียว
  - ข่าวกลาง = สีเหลือง
  - ข่าวไม่ดี / ข่าวเสี่ยง = สีแดง



## อัปเดต v2.2.9: Watchlist บันทึกได้ 10 ตัว + เลือกแล้วโหลดข้อมูลทันที

เวอร์ชันนี้ปรับปุ่ม **⭐ WATCHLIST** ให้ใช้งานเป็นระบบ Watchlist จริงมากขึ้น:

- บันทึกได้สูงสุด 10 ตัว
- กดปุ่ม WATCHLIST แล้วจะเพิ่มตัวปัจจุบันเข้า Watchlist และเปิดหน้ารายการทันที
- ถ้าตัวนั้นมีอยู่แล้ว จะอัปเดตข้อมูลล่าสุดและเปิดรายการ
- ในหน้ารายการ Watchlist มีปุ่ม `ดูตัวนี้`
- เมื่อกด `ดูตัวนี้` ระบบจะตั้งค่า asset type / ticker / market ให้เอง แล้ววิเคราะห์ตัวนั้นทันที
- มีปุ่ม `ลบ` เพื่อลบรายการออกจาก Watchlist
- แสดงสถานะปุ่มเป็น `★ WATCHLIST x/10`
- ถ้าเต็ม 10 ตัว ระบบจะแจ้งเตือนและไม่เพิ่มรายการใหม่
- ยังเก็บด้วย `localStorage` ในเครื่อง/เบราว์เซอร์ของผู้ใช้เหมือนเดิม
