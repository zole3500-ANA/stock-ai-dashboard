...
## อัปเดต v2.2.7: ใส่สีตามความหมายให้ทุกเมนูที่กดดูรายละเอียดได้

เวอร์ชันนี้เพิ่มการแสดงสีเชิงความหมายให้กว้างขึ้นทั้งบน **การ์ดด้านล่าง** และ **Modal รายละเอียด** ของเมนูที่กดเข้าไปดูได้:

- บวก / ดี / หนุน / น่าสนใจ = **สีเขียว**
- กลาง / รอดู / ต้องตรวจเพิ่ม = **สีเหลือง**
- ลบ / เสี่ยง / กดดัน = **สีแดง**

ครอบคลุมกับเมนูหลักที่กดดูได้ เช่น:

- แผนจุดเข้า-ออก
- Smart Money
- สรุปข่าวสำคัญ
- Social Sentiment
- Catalyst / ปฏิทินเหตุการณ์
- รายละเอียดคะแนน
- รายละเอียด Agent
...
รวมถึงการ์ดด้านล่างจะมีโทนสีตามภาพรวมของข้อมูลในเมนูนั้นด้วย เพื่อให้อ่านและตัดสินใจได้เร็วขึ้น
